<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST"){
        ...
        if(!$estacionamientos){
            $errores[] = "Cantidad de estacionamientos?";
        }
        if(!$vendedor){
        ...
        if(empty($errores)){
            ...
            VALUES ('$titulo' , '$precio' ,'$nombreImagen', '$descripcion' , '$habitaciones' , '$baños' , '$estacionamientos' ,'$creado', '$vendedor') 
            ; ";
        ...
        <!--  method decide como y a donde se envia la informacion del formulario
           ...
           -->
            ...
            <fieldset>
                ...
                <input type="number" id="estacionamiento" name="estacionamientos" placeholder="Cantidad de estacionamientos" min="1" max="9" value="<?php echo $estacionamientos; ?>"> 
